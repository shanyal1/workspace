...
#          This function will (1) use the results in the results dictionary to calculate these statistics. 
#          This function will then (2) put the results statistics in a dictionary
...
def calculates_results_stats(results_dic):
    ...
    """        
    results_stats_dic = {}
    # calculates the statistics of the results of the programrun using the classifier's model 
    # architecture to classify the images. 
    ...
    results_stats_dic['n_correct_dogs'] = 0 #done
    ...
    # put the results statistics in a dictionary (results_stats_dic) that's created and returned by this function

    results_stats_dic['pct_match'] = (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs']) / n_images        
    results_stats_dic['pct_correct_dogs'] = results_stats_dic['n_correct_dogs'] / results_stats_dic['n_dogs_img']
    results_stats_dic['pct_correct_breed'] = results_stats_dic['n_correct_breed'] / n_images
